                ...
                <div style="--cols-default: repeat(1, minmax(0, 1fr)); --cols-lg: repeat(3, minmax(0, 1fr));"
                            ...
                            <div class="p-6 ">
                                <div style="--cols-default: repeat(1, minmax(0, 1fr)); --cols-lg: repeat(2, minmax(0, 1fr));"
                                    ...
                                    <div>
                                        ...
                                        <x-text-input id="slug" class="block mt-1 w-full" type="text" disabled
                                            name="slug" value="{{ $template != null ? $template->slug : null }}"
                                            required autofocus autocomplete="name" />
                                    ...
                                    class="flex flex-col gap-1 col-[--col-span-default]  mb-[20px]">
                                        ...
                                        <x-input-select id="type" name="type" class="block mt-1 w-full">
                                            <x-slot name="content"> 
                                                <option value="colaborador" {{$template!=null && $template->type == 'colaborador' ? 'selected' : ''}}>Colaboradores</option>
                                                <option value="colaborador" {{$template!=null && $template->type == 'responsible' ? 'selected' : ''}}>Responsavel pela Area</option>
                                                <option value="colaborador" {{$template!=null && $template->type == 'locate_work' ? 'selected' : ''}}>Locais de trabalho</option>
                                                <option value="equipamento" {{$template!=null && $template->type == 'equipamento' ? 'selected' : ''}}>Equipamentos</option> 
                                              </x-slot>
                                        </x-input-select>
                                    </div>
                    ...
                    <div style="--col-span-default: span 1 / span 1; --col-span-lg: span 1 / span 1;"
                        ...
                        <div style="--cols-default: repeat(1, minmax(0, 1fr));"
                            ...
                            <section
                            class="rounded-xl bg-white shadow-sm ring-1 ring-zinc-950/5 dark:bg-zinc-800 dark:ring-white/10 ">
                            <button id="functions_form" type="submit"
