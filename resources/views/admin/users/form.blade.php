                        ...
                        <div style="--cols-default: repeat(1, minmax(0, 1fr));"
                            ...
                            <section
                                ...
                                <button id="user_form" type="submit"
                                    class="btn bg-primary hover:bg-primary-hover w-full py-3 px-5 text-white rounded-xl text-base font-medium  shadow-sm">
                                    {{ __('Save') }}
                                </button>
                            </section>
                            <section
                                ...
                                <div class="border-t border-gray-200 dark:border-white/10">
                                    <div class="p-6 flex flex-col gap-4">
                                        <div class="">
                                            ...
                                            <span
                                                class="text-xs text-zinc-600 dark:text-zinc-300">{{ __('Este usuário ficará oculto em todos os canais.') }}</span>
                                        </div>
