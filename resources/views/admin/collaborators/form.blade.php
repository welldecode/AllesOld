                            ...
                            <div class="p-6 ">
                                <div style="--cols-default: repeat(1, minmax(0, 1fr)); --cols-lg: repeat(2, minmax(0, 1fr));"
                                    ...
                                    <div>
                                        ...
                                        <x-text-input id="email" class="block mt-1 w-full" type="text" disabled
                                    ...
                                    <div style="--col-span-default: 1 / -1; "
                                        ...
                                        <x-input-select id="role" name="role">
                                            <x-slot name="content">
                                                ...
                                                <option value="{{ lcfirst($function->name) }}" {{$template!=null && lcfirst($template->role) == lcfirst($function->name) ? 'selected' : ''}}> {{ $function->name }} </option>
                                                 @endforeach
                                            </x-slot>
                                        </x-input-select>
                                    </div>
