                    ...
                    <x-table>
                        ...
                        <x-slot:body>
                            @foreach ($list as $entry)
                                <tr>
                                    <td class="name"> {{ $entry->frotas }}</td>
                                    <td class="name"> {{ $entry->model }}</td>
                                    <td class="name"> {{ $entry->plate }}</td>
                                    <td class="name"> {{ ucfirst($entry->type) }}</td>
                                    ...
                                    <td class="name flex items-center gap-4">
                                        ...
                                        <a size="none" variant="ghost-shadow" class="lqd-btn inline-flex items-center justify-center gap-1.5 text-xs font-medium rounded-full transition-all hover:-translate-y-0.5 hover:shadow-xl hover:shadow-black/5 disabled:opacity-50 disabled:pointer-events-none lqd-btn-ghost-shadow bg-background text-foreground shadow-xs hover:bg-primary hover:text-primary-foreground dark:hover:bg-foreground dark:hover:text-background focus-visible:bg-primary focus-visible:text-zinc-400 dark:bg-white/[3%] dark:focus-visible:bg-zinc-600 dark:focus-visible:text-zinc-500 btn-size-none  btn-hover-none size-9"
                                            href="{{ route('dashboard.equipment.delete', $entry->id) }}"
                                            title="{{ __('Delete') }}">
