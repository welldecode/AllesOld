<x-app-layout>
    ...
    <article class="flex flex-col gap-y-14 mt-10 py-8 max-w-8xl mx-auto">
                                    ...
                                    <div class="user-input-group input-group control-group flex-col !py-5  relative  rounded-[--tblr-border-radius]"
                                        ...
                                        <div style="--cols-default: repeat(1, minmax(0, 1fr)); --cols-lg: repeat(3, minmax(0, 1fr));"
                                            ...
                                            @if ($template != null)
                                                ...
                                                <div   class="bg-zinc-50 relative dark:bg-zinc-900 p-8 ring-1 ring-zinc-950/5 rounded-md group-schedule flex flex-col gap-7 w-full mb-10 pt-5">
                                                    <div style="--cols-default: repeat(1, minmax(0, 1fr)); --cols-lg:  repeat(3, 1fr);"
                                                    ...
                                                    <div style="--cols-default: repeat(1, minmax(0, 1fr)); --cols-lg: repeat(2 , minmax(0, 1fr));"
                                                        ...
                                                        <div>
                                                            ...
                                                            <x-text-input id="timer"
                                                                ...
                                                                type="datetime-local" name="timer" value="{{ $template != null ? $question->timer : null }}" /> <span
                                                        ...
                                                        <div>
                                                            ...
                                                            <x-text-input id="timer_f"
                                                                ...
                                                                type="datetime-local" name="timer"  value="{{ $template != null ? $question->timer_f : null }}" /> <span
                                                                class="text-zinc-500 dark:text-zinc-400 mb-1 font-normal text-sm -mt-1">
                                                                Isso não se aplica
                                                                aos colaboradores.</span>
                                                        </div>
                                                    ...
                                                    <div style="--cols-default: repeat(1, minmax(0, 1fr)); --cols-lg: repeat(2 , minmax(0, 1fr));"
                                                        ...
                                                        <div class=" ">
                                                            <x-input-label for="check_grade" :value="__('Selecione o status da grade.')" />
                                                            <select name="check_grade" id="check_grade"
                                                                placeholder="Selecione o status da grade..."
                                                                class="check_grade selectCollaborator dark:bg-zinc-900  "> 
                                                                <option value="true"    {{ $question->check_grade == 'true' ? 'selected' : '' }}>Disponivel</option>
                                                                <option value="false"    {{ $question->check_grade == 'false' ? 'selected' : '' }}>Indisponivel</option>
                                                            </select>
                                                            <span
                                                                class="text-xs text-zinc-600 dark:text-zinc-300">Selecione
                                                                uma das opções acima para alterar o status dos
                                                                Colaboradores e Equipamentos.</span>
                                                        </div>
                                                    </div>
                                            ...
                                            @else
                                                <div class="  border-t border-gray-200 dark:border-white/10 pt-10"
                                                    data-inputs-id="1">
                                                    <div
                                                        class="bg-zinc-50 relative dark:bg-zinc-900 p-8 ring-1 ring-zinc-950/5 rounded-md group-schedule flex flex-col gap-7 w-full mb-10 pt-5">
                                                        <div style="--cols-default: repeat(1, minmax(0, 1fr)); --cols-lg:  repeat(3, 1fr);"
                                                            class="grid grid-cols-[--cols-default] lg:grid-cols-[--cols-lg] fi-fo-component-ctn gap-6">
                                                            <div>
                                                                <x-input-label for="equipaments" :value="__('Equipment')" />
                                                        ...
                                                        <div style="--cols-default: repeat(1, minmax(0, 1fr)); --cols-lg: repeat(2 , minmax(0, 1fr));"
                                                            ...
                                                            <div>
                                                                ...
                                                                <x-text-input id="timer"
                                                                    class="block mt-1 w-full timer"
                                                                    type="datetime-local" name="timer" /> <span
                                                                    class="text-zinc-500 dark:text-zinc-400 mb-1 font-normal text-sm -mt-1">
                                                                    Isso não se aplica
                                                                    aos colaboradores.</span>
                                                            </div>
    ...
    <template id="geral">
        <div class=" border-t border-gray-200 dark:border-white/10 pt-10" data-inputs-id="1">
            <div
                class="bg-zinc-50 relative dark:bg-zinc-900 p-8 ring-1 ring-zinc-950/5 rounded-md  group-schedule flex flex-col  gap-7 w-full mb-10  pt-5">
                <div style="--cols-default: repeat(1, minmax(0, 1fr)); --cols-lg:  repeat(3, 1fr);"
                    class="grid grid-cols-[--cols-default] lg:grid-cols-[--cols-lg] fi-fo-component-ctn gap-6">
                ...
                <div style="--cols-default: repeat(1, minmax(0, 1fr)); --cols-lg: repeat(2 , minmax(0, 1fr));"
                    ...
                    <div>
                        ...
                        <x-text-input id="timer" class="block mt-1 w-full timer" type="datetime-local"
                            name="timer" /> <span
                    ...
                    <div>
                        ...
                        <x-text-input id="timer_f" class="block mt-1 w-full timer_f" type="datetime-local"
                            name="timer" /> <span
                            class="text-zinc-500 dark:text-zinc-400 mb-1 font-normal text-sm -mt-1"> Isso não se aplica
                            aos colaboradores.</span>
                    </div>
                ...
                <div style="--cols-default: repeat(1, minmax(0, 1fr)); --cols-lg: repeat(2 , minmax(0, 1fr));"
                    ...
                    <div>
                        ...
                        <select name="collaborators" id="collaborators" placeholder="Pesquise por um colaborador..."
                            class="selectCollaborator dark:bg-zinc-900 collaborators_extras">
                            <option value="Nenhum" selected>
                                Selecione um Colaborador Extra</option>
                            @foreach ($collaborators as $collaborator)
                    ...
                    <div class=" ">
                        <x-input-label for="check_grade" :value="__('Selecione o status da grade.')" />
                        <select name="check_grade" id="check_grade" placeholder="Selecione o status da grade..."
                            class="check_grade selectCollaborator dark:bg-zinc-900  ">
                            <option value="true">Disponivel</option>
                            <option value="false">Indisponivel</option>
                        </select>
                        <span class="text-xs text-zinc-600 dark:text-zinc-300">Selecione uma das opções acima para alterar o status dos Colaboradores e Equipamentos.</span>
                    </div>
                </div>
