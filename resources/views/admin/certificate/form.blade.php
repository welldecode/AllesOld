    ...
    <section class="flex flex-col gap-y-14 py-8">
        <header class="flex flex-col gap-4   ">
            ...
            <h1 class="text-2xl font-bold tracking-tight text-gray-950 dark:text-white sm:text-3xl">
                {{ __('Adicionar Certificado') }}
            </h1>
        </header>

        <div class="grid flex-1 auto-cols-fr gap-y-8">
            <form method="post" action="#" class="fi-form grid gap-y-6">
                            ...
                            <div class="p-6 ">
                                <div style="--cols-default: repeat(1, minmax(0, 1fr)); --cols-lg: repeat(2, minmax(0, 1fr));"
                                    ...
                                    <div style="--col-span-default: 1 / -1;"
                                        ...
                                        <textarea class="form-control tinymce" id="description" rows="25"></textarea>
                                    </div>
                                </div>
                        ...
                        <div style="--cols-default: repeat(1, minmax(0, 1fr));"
                            ...
                            <section
                                ...
                                <button id="user_form" type="submit"
                                    class="btn bg-blue-500 w-full py-3 px-5 text-white rounded-xl text-base font-medium  shadow-sm">
                                    {{ __('Save') }}
                                </button>
                            </section>
                            <section
